...
`datamuseum` serves as a tool for researchers of all levels and
backgrounds, as well as a pathway for improved data access from legacy
sources like museum collections.
...
- Full documentation and vignettes:
  <https://btorgovitsky00.github.io/datamuseum>
...
MIT © [Bryson Y.
Torgovitsky](https://www.linkedin.com/in/bryson-torgovitsky/), [Cheryl
L. Ames](https://https://cherylames.com/meet-the-lab/)

The `datamuseum` hex logo was designed by [Sophie
Collier](https://www.linkedin.com/in/sophie-collier-2160532a9/).
