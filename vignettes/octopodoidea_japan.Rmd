...
Several data sets exist in `datamuseum` which have been processed from their
originally accessioned forms into digestible formats to exemplify the workflow
made possible by the package. These are from the Global Biodiversity
...
The individual Japan-focused data sets can be found under **Example Data** at
the [Reference page](https://btorgovitsky00.github.io/datamuseum/reference/index.html).
...
The raw and trimmed forms of each data set can be found [on Github](https://github.com/btorgovitsky00/datamuseum/blob/master/data-raw.zip). 

## Global Biodiversity Information Facility (GBIF) Data
```{r GBIF 3/30/2026, eval = FALSE}
...
```{r InvBase 3/30/2026, eval = FALSE}
...
The refined InvBase data, cleaned to Japan-adjacent waters and superfamily
Octopodoidea, can be found at:
...
The refined BISMAL data, cleaned to Japan-adjacent waters and superfamily
Octopodoidea, can be found at:
...
> Downloaded 30 March 2026. <https://www.godac.jamstec.go.jp/bismal/e/>

## Ocean Biodiversity Information System (OBIS)
```{r OBIS 3/30/2026, eval = FALSE}
...
OBIS_clean <- OBIS_raw[ -c(0:20, 22:28, 30:39, 41, 44:63, 65:74, 76:100, 102:127, 129:203, 205:209,
...
> Ocean Biodiversity Information System (OBIS).
> Downloaded 30 March 2026. <https://obis.org>

## National Museum of Nature and Science, Japan (NSMT)
```{r NSMT 1/19/2024 + 3/11/2024, eval = FALSE}
...
These data sets, made from combining the Japan-focused data, can be found
under **Example Data** at the
[Reference page](https://btorgovitsky00.github.io/datamuseum/reference/index.html).
...
The concatenated Japanese Octopodoidea data, with repeat or absent catalog numbers removed
and specimen lots duplicated, can be found at:
[`museum`](https://btorgovitsky00.github.io/datamuseum/reference/museum.html) 

## Japan Octopodoidea Data Set, `museum_taxon`
```{r museum_taxon, eval = FALSE}
...
The Japanese Octopodoidea data, with updates to its included taxonomic data
based on functions like `taxon_validate()`, can be found at:
[`museum_taxon`](https://btorgovitsky00.github.io/datamuseum/reference/museum_taxon.html)

A map generated from [`museum_taxon`](https://btorgovitsky00.github.io/datamuseum/reference/museum_taxon.html) 
is shown below:

```{r graph, eval = FALSE, out.width = "100%"}
...
```{r figure, echo = FALSE, out.width = "100%", fig.cap = "Octopodoidea occurrences in Japan by family and genus."}
knitr::include_graphics("octopodoidea_japan.png")
```
