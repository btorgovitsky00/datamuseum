...
Several datasets exist in `datamuseum` which have been processed from their
...
System (OBIS), and one dataset obtained by direct request from the National
Museum of Nature and Science, Japan (NSMT).

The individual Japan-focused datasets can be found under **Example Data** at
