...
NSMT_clean <- read.csv(unz(trimmedzip, "data-raw/NSMT_Octopodoidea_trim.csv")) #870 Observations
...
GBIF_clean <- read.csv(unz(trimmedzip, "data-raw/GBIF_Octopodoidea_trim.csv")) #88256 Observations
...
InvBase_clean <- read.csv(unz(trimmedzip, "data-raw/InvBase_Octopodoidea_trim.csv")) #22608 Observations
...
BISMAL_clean <- read.csv(unz(trimmedzip, "data-raw/BISMAL_Octopodoidea_trim.csv")) #1547 Observations
...
OBIS_clean <- read.csv(unz(trimmedzip, "data-raw/OBIS_Octopodoidea_trim.csv")) #1130 Observations

write.csv(OBIS_clean, "OBIS_Octopodoidea_trim.csv", row.names = FALSE)
